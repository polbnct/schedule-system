    ...
    <div class="container mx-auto mt-10 p-4">
        <div class="bg-white p-8 rounded-lg shadow-2xl">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <!-- Left Column: Actions (Attendance and Excuses) -->
                <div class="space-y-8">
                    ...
                    <!-- START: NEW EXCUSE LETTER MODULE -->
                    <div class="bg-gray-50 p-6 rounded-lg border">
                        <h2 class="text-2xl font-semibold mb-4 text-gray-700">Excuse Letter Module</h2>
                        <p class="text-gray-600 mb-5">If you were absent, you can submit an excuse letter here for the admin to review.</p>
                        <div class="flex flex-col sm:flex-row sm:space-x-4 space-y-3 sm:space-y-0">
                             <a href="submit_excuse.php" class="w-full text-center bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-4 rounded-lg transition duration-300">
                                Submit New Excuse Letter
                            </a>
                            <a href="my_excuses.php" class="w-full text-center bg-gray-600 hover:bg-gray-700 text-white font-bold py-3 px-4 rounded-lg transition duration-300">
                                View My Submissions
                            </a>
                        </div>
                    </div>
                    <!-- END: NEW EXCUSE LETTER MODULE -->
                ...
                <div class="bg-gray-50 p-6 rounded-lg border">
                    ...
                    <div class="overflow-y-auto h-96 border rounded-lg">
