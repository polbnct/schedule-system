...
<body class="bg-gray-100">
    <div class="container mx-auto mt-10 p-4">
        <div class="bg-white p-8 rounded-lg shadow-2xl">
            ...
            <?php if ($message): ?>
                <div class="mb-4 p-4 rounded-lg <?php echo ($message_type == 'error') ? 'bg-red-100 text-red-700' : 'bg-green-100 text-green-700'; ?>">
                    <?php echo $message; ?>
                </div>
            <?php endif; ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-8">
                    ...
                    <div class="bg-gray-50 p-6 rounded-lg border">
                        <h2 class="text-2xl font-semibold mb-4 text-gray-700 border-b pb-2">Excuse Letter Submissions</h2>
                        <p class="text-gray-600 mb-4">
                            Review, approve, or reject excuse letters submitted by students across all programs.
                        </p>
                        <a href="excuse_letters.php" class="block w-full text-center bg-purple-600 hover:bg-purple-700 text-white font-bold py-3 px-4 rounded-lg transition duration-300">
